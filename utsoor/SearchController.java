...
public class SearchController implements Initializable {
    ...
    @FXML
    private TextField master_district;
    @FXML
    private TextField master_thana;
    @FXML
    private TextField master_blood_group;
         ...
         try {
           String ebg = bloodgroup.getText();
            ...
            while (rs.next()) {
                ...
                osman[++l] = rs.getString("bddate");
                
                Date fulldate = mdy.parse(osman[l]);

                faruk[++i] = rs.getString("bddate");
...
FXMLLoader fl  =new  FXMLLoader(getClass().getResource("FXMLDocument.fxml"));
    ...
    @FXML
    private void master_serch(ActionEvent event) {
         Connection conn = d.con();

            dat = FXCollections.observableArrayList();
            String m_district = master_district.getText();
            String m_thana = master_thana.getText();
            String m_bg = master_blood_group.getText();
        
        if(!master_district.getText().equals("") && !master_thana.getText().equals("") && !master_blood_group.getText().equals("")  )
        {
    ...
    try{    
            ResultSet rs = conn.createStatement().executeQuery("SELECT * FROM utt WHERE thana='" + m_thana + "' &&district='" + m_district + "'&& bgroup='" + m_bg + "'");
