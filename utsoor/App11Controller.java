     ...
     if(id.getText().equals("") )
        {
            ...
            JOptionPane.showMessageDialog(null, "You have to fill ID field ");
        }    
     else if(name.getText().equals("") )
        {
            System.out.println("not valid");
            JOptionPane.showMessageDialog(null, "You have to fill NAME field ");
        } 
     else if(bddate.getText().equals("") )
        {
            System.out.println("not valid");
            JOptionPane.showMessageDialog(null, "You have to fill BIRTHDAY field ");
        }  
     else if(email.getText().equals("") )
        {
            System.out.println("not valid");
            JOptionPane.showMessageDialog(null, "You have to fill EMAIL field ");
        }  
     else if(bgroup.getText().equals("") )
        {
            System.out.println("not valid");
            JOptionPane.showMessageDialog(null, "You have to fill BLOOD GROUP field ");
        }  
        
         else
         {
              JOptionPane.showMessageDialog(null, "You Have Successfully Done the Operation");
            st.execute(sq);
